 ...
 * * * * * * * * Commentaires!!!
 * 
 * Nous avons test�s nos test sur plusieurs ordinateurs et on s'est rendu compte que selon l'ordinateur (canadien ou fran�ais)
 * on peut avoir des virgule ou des points pour signifier une d�cimale.
 ...
 * 
 * Il se trouve que 9 de nos tests ne marchent pas � cause d'un probl�me de '.' et de ','
 * 
